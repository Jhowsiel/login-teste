...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init() {
        title = new JLabel("Bem-Vindo ao Painel de Gestão!");
        ...
        add(description);
        description1 = new JLabel("faça login com suas informações pessoais");
        description1.setForeground(new Color(245, 245, 245));
        add(description1);
        button = new ButtonOutLine();
        button.setBackground(new Color(255, 255, 255));
        button.setForeground(new Color(255, 255, 255));
        button.setText("FAÇA O LOGIN");
    ...
    private void login(boolean login) {
        if (this.isLogin != login) {
            if (login) {
                title.setText("olá, colaborador!");
                description.setText("Insira seus dados pessoais");
                description1.setText("e comece a jornada conosco");
                button.setText("CADASTRE-SE");
            } else {
                title.setText("Bem-Vindo ao Painel de Gestão!");
